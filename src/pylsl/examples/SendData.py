...
info = pylsl.stream_info('BioSemi','features',4,100,pylsl.cf_float32,'dsffwerwer');
...
while True:
	...
	mysample = pylsl.vectorf([random.random(),random.random(),random.random(),random.random()])
	# mysample = pylsl.vectorf([0.0, 0.0, 0.0, 0.0])
